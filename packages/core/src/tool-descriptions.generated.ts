...
step's tool call, then advance. Never dump all six steps at once, and never
...
| 5 | Add these to my CRM | *nothing* — **your own** CRM connector |
...
## Five hard rules the manifest encodes
