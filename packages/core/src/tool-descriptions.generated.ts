...
| Pending-crawl (\`uncrawled\`) rows     | "Leadbay is crawling them — they'll appear in your Leadbay account as it completes" | No on-demand fetch; re-run the import later to pull them back through the MCP |
