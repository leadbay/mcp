...
IBP, which need not mention chains; the seed's positive inverse only shifts
ranking. Violators can survive, be paid for and be delivered — post-filter
them yourself and say the tier didn't enforce it. Durable enforcement →
